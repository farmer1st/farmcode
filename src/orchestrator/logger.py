"""Structured Logging for Orchestrator module.

JSON logging to stdout/stderr for orchestrator operations following 12-factor app pattern.
"""
...
def setup_logger(name: str = "orchestrator") -> logging.Logger:
    """Setup structured JSON logger for the orchestrator module.
    ...
    Example:
        ...
        logger.info(
            ...
            extra={"context": {"issue_number": 123, "from_state": "PHASE_1"}}
        )
    """
